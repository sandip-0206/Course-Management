import { IconButton, Switch, useMediaQuery, useTheme } from "@mui/material";
    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-white z-10">
      ...
      >
        ...
        <div className="space-y-6">
          {/* Profile Settings */}
          <div
            className="flex flex-wrap justify-between items-center bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md"
            style={{
          ...
          {/* Notifications */}
          <div
            className="bg-white flex flex-wrap justify-between items-center dark:bg-white-800 p-4 rounded-lg shadow-md"
            style={{
              backgroundColor: colors.primary[400],
              color: colors.grey[100],
            }}
